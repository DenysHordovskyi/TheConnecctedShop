...
namespace TheConnectedShop
{
    public class LoginPage
    {
        ...
        private IPage _page;
        private const string ExpectedUrl = "https://keatech-live-staging-frontend.azurewebsites.net/login";
        private const string ExpectedTitle = "Keatech Live - Login or get new password";
